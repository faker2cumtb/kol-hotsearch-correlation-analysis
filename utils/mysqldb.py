...
def get_mysql_conn(db_label):
    ...
    try:
        ...
        cf.read('data/config.properites')
        ...
        db = pymysql.connect(DATABASE_HOST, DATABASE_USERNAME, DATABASE_PASSWORD, DATABASE_NAME, charset='utf8')
...
def execute_mysql_sql(db_label, sql, query=False, use_fields=True, use_PK=False):
